  ...
  return (
    <div className="p-4">
      ...
      <div className="md:hidden space-y-3">
        {pending.slice(0, 12).map((r, idx) => (
          <div key={r.id ?? `p-${idx}`} className="bg-white border rounded-lg p-4 fade-in-up card-hover-smooth" style={{ animationDelay: `${idx * 45}ms` }}>
            <div className="flex items-start justify-between">
              <div className="min-w-0">
                ...
                <div className="mt-2 text-xs text-slate-500">{r.created_at ? new Date(r.created_at).toLocaleDateString() : "—"}</div>
              </div>
